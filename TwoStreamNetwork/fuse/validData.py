...
class DataSet():
    def __init__(self, class_limit=None, image_shape=(224, 224), original_image_shape=(341, 256), n_snip=5,
                 opt_flow_len=10, batch_size=16, static_frame_path=os.path.join('/data/test')
                 , opt_flow_path = os.path.join('/data', 'opt_flow'), data_path=os.path.join('/data', 'data_list.csv')):
        """Constructor.
        ...
        self.static_frame_path = static_frame_path
    ...
    @staticmethod
    def get_data_list(data_path=os.path.join('/data', 'data_list.csv')):
