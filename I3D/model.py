...
WEIGHTS_PATH = {
    'rgb_kinetics_only' : '/db/s-sato/keras_weights/I3D/top/rgb_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels.h5',
    'flow_kinetics_only' : '/db/s-sato/keras_weights/I3D/top/flow_inception_i3d_kinetics_only_tf_dim_ordering_tf_kernels.h5',
    'rgb_imagenet_and_kinetics' : '/db/s-sato/keras_weights/I3D/top/rgb_inception_i3d_kinetics_only_tf_dim_ordering_tf_kernels.h5',
    'flow_imagenet_and_kinetics' : '/db/s-sato/keras_weights/I3D/top/flow_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels.h5'
}

# path to pretrained models with no top (no classification layer)
WEIGHTS_PATH_NO_TOP = {
    'rgb_kinetics_only' : '/db/s-sato/keras_weights/I3D/no_top/rgb_inception_i3d_kinetics_only_tf_dim_ordering_tf_kernels_no_top.h5',
    'flow_kinetics_only' : '/db/s-sato/keras_weights/I3D/no_top/flow_inception_i3d_kinetics_only_tf_dim_ordering_tf_kernels_no_top.h5',
    'rgb_imagenet_and_kinetics' : '/db/s-sato/keras_weights/I3D/no_top/rgb_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels_no_top.h5',
    'flow_imagenet_and_kinetics' : '/db/s-sato/keras_weights/I3D/no_top/flow_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels_no_top.h5'
}
...
def Inception_Inflated3d(include_top=True,
    ...
    if weights in WEIGHTS_NAME:
        ...
        downloaded_weights_path = weights_url
...
def sampleEvaluate(pred):
    ...
    sample_logits = pred[0] # we are dealing with just one example
